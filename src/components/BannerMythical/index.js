...
export const BannerMythical = (props) => {
    return (
        <div className={styles.bannerMythical}>
            <div className={styles.container}>
                <div className={styles.content}>
                    ...
                    <Link href='/mythical-pokemons'><span onClick={() => props.setLoading(true)} className={styles.buttonLearnMore}>See Mythical Pokemons</span></Link>
                </div>
                <div className={styles.content}>
